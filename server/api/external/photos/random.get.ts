...
export default defineEventHandler(async (event) => {
    ...
    return {
        ...
        data: photoRows.map((photo: any) => ({
            ...
            album: { id: photo.albumId, title: photo.albumTitle },
        })),
        meta: { filters: { count, albumId, tag: tag || null, orientation, visibility, fromDateTaken: fromDateTaken ? Number(fromDateTaken) : null, toDateTaken: toDateTaken ? Number(toDateTaken) : null } },
    }
})
